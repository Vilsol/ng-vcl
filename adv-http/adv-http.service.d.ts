...
declare module 'rxjs/Observable' {
    interface Observable<T> {
        handleError: {
            (errorHandlingStrategy: ErrorHandlingStrategy | string): Observable<T>;
        };
    }
}
...
export declare class ErrorHandlerService {
    ...
    attach(source: Observable<any>, errorHandlingStrategy: ErrorHandlingStrategy | string): Observable<any>;
}
